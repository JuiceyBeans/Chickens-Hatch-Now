...
public class Config {
    ...
    private static final ModConfigSpec.ConfigValue<Integer> HATCH_PROGRESS_UPDATE =
            BUILDER.comment("Time taken to update hatching progress in seconds (default: 180)")
                    .define("hatch_progress_update", 180);

    private static final ModConfigSpec.ConfigValue<Boolean> DISABLE_THROWN_EGG_SPAWNS =
